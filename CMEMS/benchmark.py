...
from utils import (load_config, Cmems, GridInterpolator,
                   ProductdVisualizer, plot_benchmark, save_results)
import os
...
if __name__ == "__main__":
    ...
    title = 'End to End CMEMS products regriding + animation generation benchmark'
